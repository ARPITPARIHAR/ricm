...
@section('meta_title',__('Edit Other Useful Information'))

@section('page_name',__('Edit Other Useful Information'))

@section('page_description',__('Edit Other Useful Information'))
@section('name')
    <li class="breadcrumb-item">
        <a href="{{ route('dashboard') }}"> <i class="feather icon-home"></i> </a>
    </li>
    <li class="breadcrumb-item"><a href="#!">{{ __('Edit Other Useful Information') }}</a>
    </li>
@endsection
@section('content')
<div class="row">
